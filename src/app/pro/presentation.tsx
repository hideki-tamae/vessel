...
const VoicePatternAdvanced = ({ type = 'safe' }) => {
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 lg:px-12 py-24 border-b border-slate-700 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 pt-12 border-t border-slate-700">
            ...
            <a 
                href="https://calendly.com/tamatixyan/30min?month=2026-03"
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-4 bg-white text-slate-900 font-semibold rounded-lg hover:bg-slate-100 transition inline-block"
              >
                機関向けブリーフィングをスケジュール
              </a>
          </div>
